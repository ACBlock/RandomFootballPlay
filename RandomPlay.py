...
for i in range(num_plays):
	...
	if "Run" in playbook.values():
		...
		playbook['Formation'].append(GenerateFormation(RB))
		playbook['Player1 Pos'].append(Players[0])
		playbook['Player1 Route'].append(Players[1])
		playbook['Player2 Pos'].append(Players[2])
		playbook['Player2 Route'].append(Players[3])
		playbook['Player3 Pos'].append(Players[4])
		playbook['Player3 Route'].append(Players[5])
		playbook['Player4 Pos'].append(Players[6])
		playbook['Player4 Route'].append(Players[7])
		playbook['Player5 Pos'].append(Players[8])
		playbook['Player5 Route'].append(Players[9])
